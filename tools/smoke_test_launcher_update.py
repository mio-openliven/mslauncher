...
def main() -> None:
    ...
    assert get_launcher_update_notice({"launcher_version": "1.9.1"}) == {}
    ...
    update_notice = get_launcher_update_notice(
        {
            ...
            "launcher_download_url": "https://github.com/OWNER/REPO/releases/download/v1.9.2/MSLaunchSetup.exe",
            "launcher_sha256": "a" * 64,
            "launcher_notes": "Small update",
        }
    )
    assert update_notice["version"] == "1.9.2"
    ...
    assert accepted["launcher_version"] == "1.9.2"
