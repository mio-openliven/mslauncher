...
from app_paths import backup_broken_config, copy_default_config, get_default_profiles_directory
...
def load_launcher_config(config_path: str | Path) -> tuple[dict[str, object], str]:
    ...
    try:
        ...
        return default_config, str(backup_path)
...
def save_launcher_config(config: dict[str, object], config_path: str | Path) -> None:
    path = Path(config_path)
