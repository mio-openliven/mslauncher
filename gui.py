...
from PyQt6.QtCore import QEvent, QPointF, QSize, QTimer, QThread, Qt, QUrl
...
from launcher_i18n import TRANSLATIONS
from launcher_update import APP_DISPLAY_NAME, APP_VERSION, get_launcher_update_notice, parse_version_numbers
from launcher_workers import BuildConfigWorker, DownloadWorker, LauncherUpdateWorker, LaunchWorker, VersionsWorker
...
class MSLauncherWindow(QMainWindow):
    ...
    def show_config_repair_warning_if_needed(self) -> None:
        backup_path = get_config_load_warning() or get_last_config_backup_path()
        if backup_path:
